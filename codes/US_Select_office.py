...
# All articles load
articles = pd.read_excel('US_All Articles' + datetime.now().strftime("_%y%m%d") + '.xlsx')
...
Articles_Final.to_excel('US_Final Selected Articles' + datetime.now().strftime("_%y%m%d") + '.xlsx')
